      ...
      },
      {
        ...
        onPress: async () => {
          try {
            ...
            // Don't navigate - the UserContext change will automatically 
            // trigger the navigation through App.tsx conditional rendering
            // The auth state change will show the Login screen automatically
